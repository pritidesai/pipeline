...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelineTaskRunState) DeepCopyInto(out *PipelineTaskRunState) {
	*out = *in
	if in.DAGTasks != nil {
		in, out := &in.DAGTasks, &out.DAGTasks
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.FinalTasks != nil {
		in, out := &in.FinalTasks, &out.FinalTasks
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineTaskRunState.
func (in *PipelineTaskRunState) DeepCopy() *PipelineTaskRunState {
	if in == nil {
		return nil
	}
	out := new(PipelineTaskRunState)
